...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            ...
            model = load_model(os.path.join(root_dir, 'logreg_bow_model.pkl'))
            ...
            report, cm, accuracy = evaluate_model(model, X_test_bow, y_test)
            ...
            # Add important tags
            mlflow.set_tag("model_type", "Logistic Regression (BoW)")
